...
function Coins(props) {
  ...
  return (
    <>
      <section className="text-gray-600 body-font mx-auto max-w-7xl">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center border-gray-100 border border-spacing-8 rounded-md">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <div className="flex lg:flex-row md:flex-col">
              <button className="btn btn-disabled mr-3">
                <svg
                ...
                <span className="ml-4 flex items-start flex-col leading-none">
                  <span className="text-xs text-gray-600 mb-1 italic">
                    COMING SOON
                  </span>
